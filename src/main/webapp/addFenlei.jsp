...
<script type="text/javascript">
	...
	function validateFname() {
		...
		var fname = document.fenlei.name;

		var fnameReg = /^[\u0391-\uFFE5_A-z0-9]{2,15}$/;
		...
		ajax({
			method : "POST",
			url : "FenleiServlet",
			params : "action=validateFname&fname=" + fname.value,
			type : "text",
			success : function(data) {
				...
				if (fnameReg.test(fname.value)) {
					...
					if (data == "0") {//图书名称已经存在
						...
						FnameMsg.style.color = "darkcyan";

						FnameMsg.innerHTML = "此分类名称可以添加";
					...
					FnameMsg.innerHTML = "必须是长度为2-15的汉字字母数字下划线";
	...
	<form action="FenleiServlet?action=addFenlei" method="post"
		...
		<br>
	                ...
	                <div class="form-group">
						...
						<input type="text" name="fname" class="form-control" onblur="validateName()" placeholder="分类名称"/>
